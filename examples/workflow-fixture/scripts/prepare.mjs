...
const reactDirectory = process.env.CONNECTOR_REACT_MODULE_DIR || root;
...
console.log('Prepared isolated fixture assets from locally installed React. Run npm ci to reproduce the locked default.');
