...
// This file is canonical here; crates/mcp-server/src/mcp_tool_schema.rs is a byte-for-byte
// vendored copy so the standalone crate packages self-contained for crates.io (a parity test
// there fails until you re-copy after editing this file).
// Single import only: the two crates format their copies under editions 2024 and 2021, and the
// two style editions sort multi-item imports differently — two or more imports here make
