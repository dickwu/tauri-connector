...
impl ConnectorBuilder {
    ...
    /// Set the port range. Default: 9555-9655.
        ...
        PluginBuilder::<Wry>::new("connector")
            ...
            .setup(move |app, _api| {
                ...
                tauri::async_runtime::spawn(async move {
                    ...
                    // 4. Start external WebSocket server
                    let server = match Server::new(&bind_address, port_range, bridge, plugin_state) {
                        Ok(s) => s,
                        Err(e) => {
                            eprintln!("[connector] Failed to create server: {e}");
                            return;
                        }
                    };
                    ...
                    println!(
                        "[connector] Plugin initialized for '{}' ({}) on {}:{}",
